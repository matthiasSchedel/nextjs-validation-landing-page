...
export function FigmaExample05Template(): JSX.Element {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_0%_0%,rgba(15,118,110,0.16),transparent_40%),radial-gradient(circle_at_100%_10%,rgba(91,135,255,0.2),transparent_36%),#fbfcff] text-[#0f172a]">
      ...
      <section className="mx-auto w-full max-w-6xl px-6 pb-20 pt-4">
        <p className="mx-auto inline-flex rounded-full border border-[#d9deea] bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#4257a9]">
          {config.hero.badge ?? "New launch"}
        </p>
        <h1 className="mt-6 max-w-4xl text-4xl font-semibold tracking-[-0.04em] text-[#101528] md:text-6xl md:leading-[1.02]">
        ...
        <div className="mt-10 grid gap-6 md:grid-cols-[1.05fr_0.95fr]">
          <div className="rounded-3xl border border-[#dce2ef] bg-white p-6 shadow-sm">
          ...
          <aside className="rounded-3xl border border-[#d5ddf1] bg-white p-6 shadow-[0_26px_60px_rgba(15,23,42,0.12)]">
